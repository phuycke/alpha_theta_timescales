...
# general title
fig.suptitle(r"$\theta$ power ~ fast timescale", fontsize = 8) 
...
plt.savefig(fname = os.path.join(FIG, "Figure 4C.tiff"), dpi = 800)
plt.savefig(fname = os.path.join(FIG, "Figure 4C.pdf"), dpi = 800)
