...
# general title
fig.suptitle(r"$\alpha$ power ~ slow timescale", fontsize = 8) 
...
plt.savefig(fname = os.path.join(FIG, "Figure 3D.tiff"), dpi = 800)
plt.savefig(fname = os.path.join(FIG, "Figure 3D.pdf"), dpi = 800)
