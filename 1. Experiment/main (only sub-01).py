...
speedy                = False      # speedy mode activated or not? 

# INT
subject_number        = 6          # the subject number
...
# experiment block
exp_trials = np.reshape(trials,   (10, 64, 1))
exp_id     = np.reshape(trial_id, (10, 64, 3))
exp_resp   = np.reshape(expected, (10, 64, 1))
